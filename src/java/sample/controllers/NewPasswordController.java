...
public class NewPasswordController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String email = (String) session.getAttribute("MAIL_CODE");
            ...
            if (checkValidation) {
                boolean checkInsert = dao.updatePassword(newpassword, email);
                if (checkInsert) {
                    url = SUCCESS;
                } else {
                    userError.setError("Unknown Error!");
                    request.setAttribute("NEWPASSWORD_ERROR", userError);
                }
            } else {
                request.setAttribute("NEWPASSWORD_ERROR", userError);
            }
            ...
            log("Error at NewPasswordController: " + e.toString());
        } finally {
