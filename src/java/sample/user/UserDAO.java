...
public class UserDAO {
    ...
    private static final String LOGIN = "SELECT userID, fullname, email, roleID FROM tblUsers WHERE userID = ? AND password = ?";
    private static final String SEARCH = "SELECT userID, fullname, email, roleID FROM tblUsers WHERE fullName LIKE ?";
    ...
    private static final String INSERT = "INSERT INTO tblUsers(userID, fullName, email, roleID, password) VALUES(?, ?, ?, ?, ?)";
    private static final String UPDATE_PASSWORD = "UPDATE tblUsers SET password = ? WHERE email = ?";
    private static final String TOP1_USER = "SELECT top 1 userID, fullName FROM tblUsers";
        ...
        try {
            ...
            if (conn != null) {
                ...
                if (rs.next()) {
                    ...
                    user = new UserDTO(userIDfromDB, fullName, email, roleID, "***");
                }
            }
        } finally {
            if (rs != null) {
        ...
        try {
            ...
            if (conn != null) {
                ...
                while (rs.next()) {
                    ...
                    String roleID = rs.getString("roleID");
                    String password = "***";
                    list.add(new UserDTO(userID, fullName, email, roleID, password));
                }
            }
        } finally {
            if (rs != null) {
    ...
    public boolean updatePassword(String newpassword, String email) throws ClassNotFoundException, SQLException, NamingException {
        boolean check = false;
        Connection conn = null;
        PreparedStatement ptm = null;
        ResultSet rs = null;
